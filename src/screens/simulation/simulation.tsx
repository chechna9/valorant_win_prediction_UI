...
import Disp1Context from "../../utils/contexts/disp1_context";
import Disp2Context from "../../utils/contexts/disp2_context";
...
const SimulationPage = () => {
  ...
  const disp1Value = useMemo(
    () => ({ dispAgents1, setDispAgents1 }),
    [dispAgents1, setDispAgents1]
  );
  const disp2Value = useMemo(
    () => ({ dispAgents2, setDispAgents2 }),
    [dispAgents2, setDispAgents2]
  );
  ...
  return (
    <Disp2Context.Provider value={disp2Value}>
      <Disp1Context.Provider value={disp1Value}>
      ...
      </Disp1Context.Provider>
    </Disp2Context.Provider>
  );
};
